...
public class ConfigToggleButton<T extends Enum<T>> extends CustomIconButton {
    ...
    public ConfigToggleButton(ConfigEntry.EnumEntry<T> configValue, T val, IHandler<ConfigToggleButton<T>> onPress) {
        this(configValue, val, t -> true, onPress);
    }

    public ConfigToggleButton(ConfigEntry.EnumEntry<T> configValue, T val, Predicate<T> isValidValue, IHandler<ConfigToggleButton<T>> onPress) {
    ...
    private static <T extends Enum<T>> void registerApp(Blitter blitter, ConfigEntry.EnumEntry<T> setting, T val, LocalizationEnum title, Component... tooltipLines) {
    ...
    private static <T extends Enum<T>> void registerApp(ItemLike item, ConfigEntry.EnumEntry<T> setting, T val, LocalizationEnum title, Component... tooltipLines) {
        var lines = new ArrayList<Component>();
        lines.add(title.text());
        Collections.addAll(lines, tooltipLines);
    ...
    private static <T extends Enum<T>> void registerApp(Blitter blitter, ConfigEntry.EnumEntry<T> setting, T val, LocalizationEnum title, LocalizationEnum... hints) {
    ...
    public List<Component> getTooltipMessage() {
        ...
        ButtonAppearance buttonAppearance = appearances.get(new EnumPair<>(this.configValue, this.currentValue));
